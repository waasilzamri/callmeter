...
#### v2.3.18.7 ####
  ...
  * inner changes
#### v2.3.18.6 ####
  * fix translation causing FCs
#### v2.3.18.5 ####
  * fix translation causing FCs
#### v2.3.18.4 ####
  * update translations
  * prepare for jelly bean
#### v2.3.18.3 ####
  * reduce app size
  * update translations
#### v2.3.18.2 ####
  ...
  * update translations
#### v2.3.18.1 ####
  * Fix for HC/ICS devices
  * update translations
#### v2.3.18 ####
  * Merge new data stats from Call Meter 3G
  * update translations
#### v2.3.17.10 ####
...
#### v2.3.17.6 ####
  * Translation updates
#### v2.3.17.5 ####
  * Fix language selection for german+danish ([issue #442](https://code.google.com/p/callmeter/issues/detail?id=#442))
  * add an other hint for data stats ([issue #441](https://code.google.com/p/callmeter/issues/detail?id=#441))
#### v2.3.17.4 ####
  * fix for android 1.5
#### v2.3.17 ####
  ...
  * minor fixes
  * translation updates
  * add (not yet finished) danish translation
#### v2.3.16 ####
  * Add support for GT-S5830
...
#### v2.3.12 ####
  * Turkish translation
  * Samsung GT-I5500 ([issue #246](https://code.google.com/p/callmeter/issues/detail?id=#246))
#### v2.3.11 ####
  * Fix some FCs
#### v2.3.10 ####
...
#### v2.3.9 ####
  ...
  * fix some FC
#### v2.3.8 ####
  * Support Samsung Galxy S GT-I9000 ([issue #155](https://code.google.com/p/callmeter/issues/detail?id=#155))
#### v2.3.7 ####
...
#### v2.3.3 ####
  * Fix missing plan 2 ([issue #79](https://code.google.com/p/callmeter/issues/detail?id=#79))
  * Fix missing callcounter when merging sms into calls ([issue #80](https://code.google.com/p/callmeter/issues/detail?id=#80))
#### v2.3.2 ####
  * Hotfix for android-1.5 ([issue #76](https://code.google.com/p/callmeter/issues/detail?id=#76))
#### v2.3.1 ####
  * Fix polish translation
#### v2.3 ####
  * Change layout ([issue #64](https://code.google.com/p/callmeter/issues/detail?id=#64))
  * show contacts name in excluded numbers ([issue #55](https://code.google.com/p/callmeter/issues/detail?id=#55))
